...
// Stop user from going back after logout
...
<body>
    <header class="flex">
        ...
        <a class="mth-h1" href="homelogin.php"><strong>Mock Test Hunter</strong></a>
        <div class="login-home">
            <button class="btn-login"><a id="btnlogin-link" href="logout.php">log-out<i class="fa-sharp fa-solid fa-arrow-right"></i></a></button>
            <span class="name"><?php echo $fname[0];echo $lname[0] ?></span>
            <img class="profile-img" src="<?php echo $img ?>"></img>          
        </div>
